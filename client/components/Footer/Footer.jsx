    ...
    return (
        <footer className="w-full bg-black text-white py-10">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                {/* Company Info */}
                <div>
                    <img src="../../assests/clickjob.png" alt="ClickJob Logo" className="w-20 h-auto mb-4" />
            ...
            <div className="max-w-7xl mx-auto px-4 mt-10 border-t border-gray-700 pt-6 text-sm">
                ...
                <div className="flex space-x-6 items-center text-gray-300">
                    <a href="https://www.facebook.com/clickjob" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 flex items-center space-x-2">
                        <FaFacebookF className="text-lg" />
                        <span>Facebook</span>
                    </a>
                    <a href="https://www.twitter.com/clickjob" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 flex items-center space-x-2">
                        <FaTwitter className="text-lg" />
                        <span>Twitter</span>
                    </a>
                    <a href="https://www.instagram.com/clickjob" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 flex items-center space-x-2">
