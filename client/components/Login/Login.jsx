                        ...
                        {!showForgot ? (
                            <form onSubmit={handleLogin}>
                                ...
                                <div className="flex justify-end mt-5">
                                    <button type="button" className="text-xs text-gray-500" onClick={() => setShowForgot(true)}>
                                        Forgot Password?
                                    </button>
                                </div>
                            ...
                            <form onSubmit={handleForgotPassword}>
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <button type="button" className="text-xs text-gray-500 uppercase" onClick={() => setShowForgot(false)}>
                                        Back to Login
                                    </button>
                                    <span className="border-b w-1/5 md:w-1/4"></span>
                                </div>
